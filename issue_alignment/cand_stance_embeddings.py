...
import pandas as pd
i = 0
candidate_stances = pd.read_csv("issue_alignment/candidate_stances.csv")
candidate_data = pd.read_csv("issue_alignment/candidate_data.csv")
for election_id, election_data in elections.items():
            ...
            if candidacy_id not in candidate_stances["candidate_id"]: # add new candidate to the datasets
                ...
                for stance in stances:
                    ...
                    if i % 50 == 0:
                        ...
                        candidate_stances.to_csv("issue_alignment/candidate_stances.csv", index=False)
                        candidate_data.to_csv("issue_alignment/candidate_data.csv", index=False)
